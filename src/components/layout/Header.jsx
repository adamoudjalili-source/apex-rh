...
// Glass neutre — s'adapte à n'importe quel fond de page
// ============================================================
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center"
            style={{ background: 'rgba(79,70,229,.15)', border: '1px solid rgba(79,70,229,.3)' }}>
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => setSearchOpen(true)}
            className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg text-white/30 hover:text-white/60 transition-all text-xs"
          ...
          <div className="flex items-center gap-2.5 px-3 py-1.5 rounded-lg cursor-pointer"
            style={{ background: 'rgba(255,255,255,.04)', border: '1px solid rgba(255,255,255,.07)' }}>
            <div className="w-6 h-6 rounded-md flex items-center justify-center text-[11px] font-bold uppercase text-white"
              style={{ background: `linear-gradient(135deg, ${ROLE_COLORS[role] || '#4F46E5'}, ${ROLE_COLORS[role] || '#4F46E5'}88)` }}>
              {initiale}
            </div>
            <div className="hidden md:block">
              <p className="text-xs font-semibold text-white leading-none mb-0.5">{fullName}</p>
              <p className="text-[10px] leading-none font-medium"
