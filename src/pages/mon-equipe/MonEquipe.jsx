  ...
  return (
    <div className="h-full rounded-2xl flex flex-col overflow-hidden"
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {/* Dimensions */}
        <div>
          <p className="text-[10px] text-white/20 uppercase tracking-wider mb-2">Dimensions IPR</p>
          <div className="space-y-0.5">
            ...
            <DimDetail icon={<TrendingUp size={10}/>}     label="Régularité briefs" value={m.briefRate}   color={iprColor(m.briefRate)}   suffix="%"/>
          </div>
        </div>
...
function DimDetail({ icon, label, value, color, suffix }) {
  return (
